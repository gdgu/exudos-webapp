...
exports.getAssignmentObjectId = (assignment, callback) => {
    dbManip.queryId(assignment, 'assignments', callback)
}
...
exports.submitAssignment = (assignmentSubmission, callback) => {
    dbConnect((err, dbL) => {
        ...
        db.collection('assignmentSubmissions').insertOne(assignmentSubmission, (err, res) => {
